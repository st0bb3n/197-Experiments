...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="https://github.com/st0bb3n/197-Experiments/blob/main/KeywordSpotting-SPEECHCOMMANDS/checkpoint-torchscript.pt")
...
if __name__ == "__main__":
    ...
    checkpoint = 'checkpoint-torchscript.pt'
